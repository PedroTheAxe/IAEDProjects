...
if (!empty($_POST["anomaliaredacao"])){
    if($_POST["anomaliaredacao"] == "true"){
        ?>
        <form name="myform" action = "insert_anomalia.php" method ="post">
        ...
        <p><input type="hidden" name="descricao"
        value="<?=$_POST["descricao"]?>"/></p>
        ...
        ?>
        <form action = "insert_anomalia.php" method ="post">
        <p><input type="hidden" name="id"
        value="<?=$_POST["id"]?>"/></p>
