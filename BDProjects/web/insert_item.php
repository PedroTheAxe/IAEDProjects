...
if($valid == true){
    ...
    $result = pg_execute($connection,"my_query",array($a_maxcount,$zona,$imagem,$lingua,$timestamp,$descricao_anomalia,$anomaliaredacao));
    ...
    $result = pg_execute($connection,"my_query3",array($a_maxcount,$i_maxcount,$email));
...
pg_close($connection);
if($valid == false){
    echo("<p> Item inserido sem sucesso</p>");
}
echo("<p><a
